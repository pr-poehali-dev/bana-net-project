...
const Index = () => {
  ...
  if (authLoading) {
    return <AuthGate loading={true} platform={platform} onGoogleLogin={loginWithGoogle} />;
  }

  if (!user) {
    return <AuthGate loading={false} platform={platform} onGoogleLogin={loginWithGoogle} />;
  }
